    ...
    <div className="min-h-screen bg-zinc-50 flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-16">
        <div className="w-full max-w-lg">
          <p className="text-xs font-semibold tracking-widest uppercase text-zinc-400 mb-1 text-center">
            Medicin
          </p>
          <h1 className="text-4xl font-bold text-zinc-900 tracking-tight mb-2 text-center">
            Studieöversikt
          </h1>
